...
export default function EquipmentDetailsScreen() {
  ...
  console.log("DEBUG EquipmentDetails:", {
    panel,
    detail,
    panelRotulo: panel?.rotulo,
    detailRotulo: detail?.rotulo,
    params: params.panel,
  });
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: "#fff" }]}>
      ...
      >
        <Text style={styles.equipmentLabel}>
          Equipo: {panel?.rotulo || detail?.rotulo || ""}
        </Text>
        ...
        <TouchableOpacity
          style={[
            styles.primaryBtn,
            { marginTop: 10, marginBottom: 40, backgroundColor: "#06B6D4" },
          ]}
