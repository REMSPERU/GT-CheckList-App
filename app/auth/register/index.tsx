...
const validatePasswordSpecialChar = (password: string) => /[!@#$%^&*(),.?":{}|<>]/.test(password);
...
export default function RegisterScreen() {
    ...
    const RequirementItem = ({ validation, iconName }: { validation: { valid: boolean; text: string; touched: boolean }, iconName: keyof typeof Ionicons.glyphMap }) => {
        const getColor = () => {
                        ...
                        <View style={styles.form}>
                            ...
                            {email.length > 0 && !validations.email.valid && (
                                <View style={styles.requirementsContainer}>
                                    <RequirementItem validation={validations.email} iconName="mail-outline" />
                                </View>
                            )}
                            ...
                            {username.length > 0 && !validations.username.valid && (
                                <View style={styles.requirementsContainer}>
                                    <RequirementItem validation={validations.username} iconName="person-outline" />
                                </View>
                            )}
                            ...
                            {password.length > 0 && !(validations.passwordLength.valid && validations.passwordUppercase.valid && validations.passwordNumber.valid && validations.passwordSpecialChar.valid) && (
                                <View style={styles.requirementsContainer}>
                                    <RequirementItem validation={validations.passwordLength} iconName="lock-closed-outline" />
                                    <RequirementItem validation={validations.passwordUppercase} iconName="lock-closed-outline" />
                                    <RequirementItem validation={validations.passwordNumber} iconName="lock-closed-outline" />
                                    <RequirementItem validation={validations.passwordSpecialChar} iconName="lock-closed-outline" />
                                </View>
                            )}
                            ...
                            >
                                {isLoading ? (
                                    <View style={styles.buttonLoadingContainer}>
                                        ...
                                        <Text style={[styles.buttonText, styles.buttonLoadingText]}>Creando cuenta...</Text>
                                    </View>
                                ) : (
