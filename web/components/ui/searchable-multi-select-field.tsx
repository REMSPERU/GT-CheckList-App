...
export const SearchableMultiSelectField = memo(function SearchableMultiSelectField({
  values,
  options,
  onChange,
  placeholder,
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      {isOpen && (
        <div
          id={listboxId}
          role="listbox"
          className="absolute left-0 right-0 z-50 mt-1 max-h-64 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg flex flex-col min-w-[220px]">
          ...
          {/* Options List */}
          <div className="overflow-y-auto p-1 flex-1 max-h-44 divide-y divide-slate-50">
